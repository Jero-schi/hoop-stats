        ...
        <aside className="w-64 bg-navy-dark border-r border-slate-800 flex flex-col hidden md:flex h-screen sticky top-0 overflow-hidden print:hidden">
            ...
            <div className="p-4 border-t border-slate-800">
                <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-slate-800/50 transition-colors cursor-pointer">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-slate-700 to-slate-600 flex items-center justify-center text-sm font-bold border border-slate-500">
                        C
                    </div>
